...
Na fase de Elaboraçao sera desenvolvido parte do cenario 1, Dinâmica do Jogo no modo Endurance, visando o desenvolvimento da arquitetura do jogo.

Todos os outros cenarios serao desenvolvidos na fase de Construçao, ver seçao \ref{Cenários}.

Na Iteraçao de Transiçao todos os cenarios ja devem estar implementados e em fase final de teste de aceitaçao, para que o jogo seja distribuido para os possiveis jogadores.
